...
final class MediaController: ObservableObject {
    ...
    /// Drop a tab's media when it closes. Without this the player lingers showing
    /// the closed tab's last (playing) state, and its controls no-op because the
    /// tab can no longer be resolved.
    func forgetTab(browserId: Int) {
